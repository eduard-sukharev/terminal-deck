...
class LayoutDefault(Layout):
    ...
    def _build_placements(self, placements: list[Placement]) -> None:
        ...
        if driver is not None:
            # The driver board mounts back-to-back directly behind the display
            # glass in the lid stack: its component face reaches up to the panel
            # back surface, its FPC slot faces the folded panel ribbon. Its
